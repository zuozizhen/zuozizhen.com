            ...
            <a href={`/project/${project.slug}`}>
              <div className="w-full aspect-[1480/830] flex relative items-center sm:pl-16 pl-6 overflow-hidden rounded-xl">
                <div className="w-2/5 relative z-10">
                  ...
                  <div className="flex sm:gap-6 gap-2 mt-8">
                    <div className="flex gap-1 mt-1 text-white text-opacity-50 sm:text-base text-xs mix-blend-hard-light">查看项目 -&gt;</div>
                  </div>
                </div>
                {project.image ? (
                  <img src={project.image} className="w-full object-cover absolute right-0 top-0 -z-0" alt={project.title} />
                ) : (
