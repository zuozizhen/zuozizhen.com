...
export function ShareArticle({ slug, title }) {
    ...
    <div className="flex items-center space-x-3 m-0 justify-center">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 32 32"
          fill="none"
          className="w-12 h-12 md:w-11 md:h-11 stroke-current group-hover:rotate-[-4deg] transition"
        >
          <path
          ...
          <g
            className={`transition-opacity ${
              isCopied
                ? 'opacity-100 rotate-[-4deg] transition'
                : 'opacity-0'
            }`}
          >
            <path
