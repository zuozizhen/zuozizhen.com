      ...
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            placeholder="搜索"
            className="px-4 py-2 border border-gray-300 dark:border-gray-800 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-lg bg-white dark:bg-black text-gray-900 dark:text-gray-100"
          />
          <svg
