...
![](https://image.zuozizhen.com/mastergo-project-1.jpg)

经过不断的研究分析后，我们会输出很多竞品分析报告，有关于个别功能的，也有关于整个产品的：

![](https://image.zuozizhen.com/mastergo-project-2.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-3.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-4.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-5.jpg)

#### 早期的风格探索

之后我便开始了早期的视觉风格探索，在定下了暗色的基调之后，尝试了大量不同的布局方式和细节风格：

![](https://image.zuozizhen.com/mastergo-project-6.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-7.jpg)
*左为早起原型，右为目前线上版本*
...
![](https://image.zuozizhen.com/mastergo-project-8.jpg)
![](https://image.zuozizhen.com/mastergo-login-cover.jpg)
![](https://image.zuozizhen.com/mastergo-login-flow.jpg)

#### 布局上的熟悉度和一致性

对于我们的用户来说，大家很熟悉之前使用的界面和布局方式。我们会尽量遵循用户已有的使用习惯，这样有助于减少用户学习新的功能和布局所需的时间。

![](https://image.zuozizhen.com/mastergo-project-9.jpg)

#### 新手引导

我们认为，新手引导应该是有趣的且易于理解的，所以我们为 MasterGo 的每步新手引导都绘制了对应的插画：

![](https://image.zuozizhen.com/mastergo-project-10.jpg)

另外，我们也希望对用户是无干扰的，不会阻碍哟用户正常的使用体验，所以我们的新手引导一方面对步数做了精简，另一方面，也会以固定位置显示而不阻碍用户的正常操作：

![](https://image.zuozizhen.com/mastergo-project-11.jpg)

#### 文件浏览页

文件浏览页是用户看到的第一个页面，也是用来管理文件、团队、和项目的地方：

![](https://image.zuozizhen.com/mastergo-project-12.jpg)

左侧栏顶部是不同的筛选分类，显示的文件会有些细微的差别，我们在设计图中都一一做了体现和说明：

![](https://image.zuozizhen.com/mastergo-project-13.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-14.jpg)

对于空页面，我们也为不同的类别绘制了不同的插画：

![](https://image.zuozizhen.com/mastergo-project-15.jpg)

#### 团队管理

在创建团队时，我们希望能体现团队在级别和范围上的“大”，并不希望用户把团队当作文件夹来用，所以没有使用正常的弹窗，而是做了单独的处理，其实在一定角度上也是一种心理暗示：

![](https://image.zuozizhen.com/mastergo-project-16.jpg)

团队管理界面我们希望在设计上是一致和统一的：

![](https://image.zuozizhen.com/mastergo-project-17.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-18.jpg)

在这里你会收到被邀请的通知或者评论的通知：

![](https://image.zuozizhen.com/mastergo-project-19.jpg)

#### 画布中的细节定义

因为在画布中所进行的操作是非常精确的，所以我们会非常细致的定义触发区域，例如，光标的触发区域：

![](https://image.zuozizhen.com/mastergo-project-20.jpg)
![](https://image.zuozizhen.com/mastergo-cursor.png)
图层边界框、矢量图形路径、操作控制杆的触发区域：

![](https://image.zuozizhen.com/mastergo-project-21.jpg)


另外，我们也会细致的定义在不同操作下对应的光标类型：

![](https://image.zuozizhen.com/mastergo-project-22.jpg)


我们还需要去定义画布中不同图层的边界框、操纵杆、裁剪框，等等：

![](https://image.zuozizhen.com/mastergo-project-23.jpg)

很多情况下，我们需要对于一些操作有数学化的定义，例如下方的 Shift 移动方向判断、多角形判断和复制粘贴判断：

![](https://image.zuozizhen.com/mastergo-project-24.jpg)
![](https://image.zuozizhen.com/mastergo-number.jpg)
![](https://image.zuozizhen.com/mastergo-copy.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-25.jpg)

左侧面板包含了很多功能，下面展示了图层栏、组件库、资源库等等众多的功能：

![](https://image.zuozizhen.com/mastergo-project-26.jpg)

右侧面板会在某些特定的模式下发生变化，比如像下面展示的一样，在正常编辑模式下，我们会展示图层的属性，而切换到路径编辑时，便会变为路径编辑面板。切到标注模式，右侧便会变成标注信息面板，当然还有切图面板、样式面板等等。

![](https://image.zuozizhen.com/mastergo-project-27.jpg)
![](https://image.zuozizhen.com/mastergo-right-style.jpg)
...
![](https://image.zuozizhen.com/mastergo-project-28.jpg)

属性控制弹窗：

![](https://image.zuozizhen.com/mastergo-project-29.jpg)

文字选择器和组件样式选择弹窗：

![](https://image.zuozizhen.com/mastergo-project-30.jpg)
...
![](https://image.zuozizhen.com/mastergo-website.jpg)

#### 邀请码

有趣的是，在 MasterGo 第一次内侧的时候，我们使用的是邀请码机制，为让这个过程变得更加有趣，我们启用了邀请码机制，我们为每一个邀请码都做了一张精美的邀请函:

![](https://image.zuozizhen.com/mastergo-project-32.jpg)

最终大概制作了接近 1000 多个：

![](https://image.zuozizhen.com/mastergo-project-33.jpg)

#### 愚人节活动

在愚人节的时候，我们对外发布了我们的“更新日志” 🙌：

![](https://image.zuozizhen.com/mastergo-project-34.jpg)

#### 可交互公众号

内测的时候，我们对外发布了一个可交互的公众号文章，灵感是来自于苹果的微信公众号文章，在其中应用了很多关于 SVG 动画的知识：

![](https://image.zuozizhen.com/mastergo-project-35.jpg)
...
- [MasterGo Design System 1.0](/project/mastergo-design-system)
