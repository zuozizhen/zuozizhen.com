    ...
    >
      <nav className="terminal-nav">
        ...
        <div className="nav-chips">
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/help">
            <span className="chip-icon">⌘</span> help
          </button>
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/blog">
            <span className="chip-icon">#</span> blog
          </button>
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/projects">
            <span className="chip-icon">#</span> projects
          </button>
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/resources">
            <span className="chip-icon">#</span> resources
          </button>
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/contact">
            <span className="chip-icon">#</span> contact
          </button>
          <button className="nav-chip" data-action="click->terminal#runCmd" data-cmd="/home">
            <span className="chip-icon">#</span> home
          </button>
        </div>
      </nav>
