  ...
  return (
    <header className="flex justify-between items-center py-6 mx-auto sm:py-8 border-b border-neutral-100 px-5">
      <div className="flex w-full items-center justify-between max-w-screen-lg mx-auto">
        <Link to="/" className="text-xl font-black flex gap-3">
        ...
        <nav className="hidden lg:flex gap-12 flex-shrink-0">
          <Link
            to="/blog"
            className="font-semibold text-neutral-500 hover:text-neutral-800 transition"
          >
            文章
          </Link>
          <Link
      ...
      >
        <Link to="/blog" onClick={close} className="font-semibold text-neutral-900 text-4xl">
          文章
        </Link>
        <Link to="/resource" onClick={close} className="font-semibold text-neutral-900 text-4xl">
          资源
        </Link>
        <Link to="/project" onClick={close} className="font-semibold text-neutral-900 text-4xl">
          工作项目
        </Link>
      </div>
    </header>
